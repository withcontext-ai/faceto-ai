...
func (atq *AuthTokenQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (atq *AuthTokenQuery) FirstIDX(ctx context.Context) uint64 {
...
func (atq *AuthTokenQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (atq *AuthTokenQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (atq *AuthTokenQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (atq *AuthTokenQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := atq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (atq *AuthTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(authtoken.Table, authtoken.Columns, sqlgraph.NewFieldSpec(authtoken.FieldID, field.TypeUint64))
	_spec.From = atq.sql
