...
func (lq *LinkQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (lq *LinkQuery) FirstIDX(ctx context.Context) uint64 {
...
func (lq *LinkQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (lq *LinkQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (lq *LinkQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (lq *LinkQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := lq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (lq *LinkQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(link.Table, link.Columns, sqlgraph.NewFieldSpec(link.FieldID, field.TypeUint64))
	_spec.From = lq.sql
