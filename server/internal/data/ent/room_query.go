...
func (rq *RoomQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (rq *RoomQuery) FirstIDX(ctx context.Context) uint64 {
...
func (rq *RoomQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (rq *RoomQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (rq *RoomQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (rq *RoomQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (rq *RoomQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(room.Table, room.Columns, sqlgraph.NewFieldSpec(room.FieldID, field.TypeUint64))
	_spec.From = rq.sql
